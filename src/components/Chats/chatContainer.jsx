...
export default function ChatContainer({ currentChat, user2, messages, socketSend }) {
  const [messageText, setMessageText] =useState('')
  return <div
    className="user-chat w-100 user-chat-show"
    style={{
      backgroundImage:
  ...
  >
    ...
    <div className="chat-content d-lg-flex">
      ...
      <div className="w-100  position-relative">
        ...
        >
          {/* conversation user */}
          {currentChat == "users" && <UserChat user2={user2} messages={messages}/>}
