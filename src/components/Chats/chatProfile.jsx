export default function ChatProfile({showProfile, user2, setShowProfile}) {

    return <div className={`user-profile-sidebar ${user2 && !showProfile ? "d-none" : "d-block"}`}>

        <div className="p-3 border-bottom">
            <div className="user-profile-img">
                <img src="assets/images/users/avatar-2.jpg" className="profile-img rounded" alt=""/>
                <div className="overlay-content rounded">
                    <div className="user-chat-nav p-2">
                        <div className="d-flex w-100">
                            <div className="flex-grow-1">
                                <button type="button"
                                        className="btn nav-btn text-white user-profile-show d-none d-lg-block" onClick={() => {
                            ...
                            <div className="flex-shrink-0">
                                <div className="dropdown">
                                    ...
                                    <div className="dropdown-menu dropdown-menu-end">
                                        <a className="dropdown-item d-flex justify-content-between align-items-center d-lg-none user-profile-show"
                                           href="#" onClick={() => {
                                    setShowProfile(!showProfile)
                                }}>View Profile <i className="bx bx-user text-muted"></i></a>
                                        <a className="dropdown-item d-flex justify-content-between align-items-center d-lg-none"
                                           href="#" data-bs-toggle="modal" data-bs-target=".audiocallModal">Audio <i
                                            className="bx bxs-phone-call text-muted"></i></a>
                                        <a className="dropdown-item d-flex justify-content-between align-items-center d-lg-none"
                                           href="#" data-bs-toggle="modal" data-bs-target=".videocallModal">Video <i
                                            className="bx bx-video text-muted"></i></a>
                                        <a className="dropdown-item d-flex justify-content-between align-items-center"
                                           href="#">Archive <i className="bx bx-archive text-muted"></i></a>
                                        <a className="dropdown-item d-flex justify-content-between align-items-center"
                                           href="#">Muted <i className="bx bx-microphone-off text-muted"></i></a>
                                        <a className="dropdown-item d-flex justify-content-between align-items-center"
                                           href="#">Delete <i className="bx bx-trash text-muted"></i></a>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div className="mt-auto p-3">
                        <h5 className="user-name mb-1 text-truncate">{user2.name ? user2.name : user2.first_name + "  " + user2.last_name}</h5>
                        <p className="font-size-14 text-truncate mb-0"><i
                            className="bx bxs-circle font-size-10 text-success me-1 ms-0"></i> Online</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div className="p-4 user-profile-desc" data-simplebar="">
            ...
            <div className="text-center border-bottom">
                <div className="row">
                    ...
                    <div className="col-sm col-4">
                        <div className="mb-4">
                            <button type="button" className="btn avatar-sm p-0" data-bs-toggle="modal"
                    ...
                    <div className="col-sm col-4">
                        <div className="mb-4">
                            <div className="dropdown">
                                <button className="btn avatar-sm p-0 dropdown-toggle" type="button"
                                        data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
            ...
            <div className="pb-2">
                ...
                <div>
                    ...
                    <h5 className="font-size-14 text-truncate">Bella Cote</h5>
                </div>
                        ...
                        <a href="" className="px-0">
                            <div className="d-flex align-items-center">
                                <div className="flex-shrink-0 avatar-xs me-2">
                                                    <span
                                                        className="avatar-title rounded-circle bg-light-subtle text-reset">
                                                        #
                                                    </span>
                                </div>
                                    ...
                                    <div className="dropdown">
                                        ...
                                        <div className="dropdown-menu dropdown-menu-end">
                                            <a className="dropdown-item d-flex align-items-center justify-content-between"
                                               href="#">Share <i className="bx bx-share-alt ms-2 text-muted"></i></a>
                                            <a className="dropdown-item d-flex align-items-center justify-content-between"
                                               href="#">Bookmark <i className="bx bx-bookmarks text-muted ms-2"></i></a>
                                            <div className="dropdown-divider"></div>
                                            <a className="dropdown-item d-flex align-items-center justify-content-between"
                                               href="#">Delete <i className="bx bx-trash ms-2 text-muted"></i></a>
                                        </div>
                                    </div>
                                </div>
                            </div>
